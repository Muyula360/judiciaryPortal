...
export default function Footer() {
  return (
    <footer className="w-full px-4 sm:px-6 lg:px-28 relative z-10 bg-black backdrop-blur-sm">
      <div className="w-full">
        <div className="flex items-center justify-center gap-6 py-3 md:gap-8">
          ...
          >
            <div className="w-10 h-10 md:w-12 md:h-12 rounded-full bg-white/10 hover:bg-gradient-to-r from-rose-500 to-orange-500 flex items-center justify-center transition-all duration-300 hover:shadow-lg">
        ...
        <div className="text-center">
          <h6 className="text-xs sm:text-sm pb-2 md:text-base font-extralight text-gray-400">
            © 2026. The Judiciary of Tanzania, All Rights Reserved.
          </h6>
        </div>
      </div>
    </footer>
