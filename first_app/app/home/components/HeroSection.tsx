...
export default function HeroSection({ isDarkTheme }: HeroSectionProps) {
  return (
    <section className="relative px-4 sm:px-6 lg:px-8 py-6 overflow-hidden">
      <div className="relative flex items-center justify-center gap-4 md:gap-8 lg:gap-20 z-10">
        ...
        <div className="text-center">
          <h1 className={`text-2xl sm:text-2xl md:text-3xl font-extrabold transition-colors duration-300 pt-3 ${isDarkTheme ? 'text-white' : 'text-white'}`}>
